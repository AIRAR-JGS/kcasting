...
class ActorProfileModifySubInfo extends StatefulWidget {
  ...
  const ActorProfileModifySubInfo({Key key, this.targetData}) : super(key: key);

  @override
  _ActorProfileModifySubInfo createState() => _ActorProfileModifySubInfo();
}
                                ...
                                Wrap(
                                  children: [
                                    GridView.count(
                                      ...
                                      shrinkWrap: true,
                                      crossAxisCount: 4,
                                      children: List.generate(_dialect.length,
                                          (index) {
                                        return Container(
                                            child: Row(
                                          mainAxisSize: MainAxisSize.min,
                    ...
                    children: [
                      ...
                      Expanded(
                          child: Container(
                              width: MediaQuery.of(context).size.width,
                              height: 55,
                              child: CustomStyles.blueBGSquareButtonStyle('다음',
                                  () {
