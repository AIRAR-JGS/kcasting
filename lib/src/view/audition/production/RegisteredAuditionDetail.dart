...
class _RegisteredAuditionDetail extends State<RegisteredAuditionDetail>
  ...
  Widget profileImgWidget(List<String> _imgUrlArr, int idx) {
    return Container(
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: CustomColors.colorButtonDefault.withAlpha(100),
                blurRadius: 1.0,
                spreadRadius: 1.0,
                offset: Offset(1, 1),
              )
        ...
        height: (KCastingAppData().isWeb)
            ? ((CustomStyles.appWidth / 5) * 1.2)
            : ((MediaQuery.of(context).size.width / 5) * 1.2),
        width: (KCastingAppData().isWeb)
            ? (CustomStyles.appWidth / 5)
            : (MediaQuery.of(context).size.width / 5),
        child: (_imgUrlArr.length > idx)
            ? ClipRRect(
                borderRadius: CustomStyles.circle3BorderRadius(),
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
              ...
              child: Column(children: [
                Text('지원자', style: CustomStyles.dark12TextStyle()),
                Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Visibility(
              child: Container(
                  ...
                  child: (_pickedMultipartFile == null ? null : Text(_pickedMultipartFile.filename))),
              visible: _pickedMultipartFile == null ? false : true)
          : Visibility(
              child: Container(
                  margin: EdgeInsets.only(top: 15),
                  width: (KCastingAppData().isWeb)
    ...
    return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
              margin: EdgeInsets.only(right: 15),
              child: Column(children: [
                Text('1차 합격자', style: CustomStyles.dark12TextStyle()),
                Container(
                    margin: EdgeInsets.only(top: 5),
                    child: Text(
          ...
          Container(
              margin: EdgeInsets.only(right: 15),
              child: Column(children: [
                Text('제출', style: CustomStyles.dark12TextStyle()),
                Container(
                    margin: EdgeInsets.only(top: 5),
                    child: Text(
                        StringUtils.checkedString(_secondAuditionInfo[
          ...
          Container(
              margin: EdgeInsets.only(right: 15),
              child: Column(children: [
                Text('미제출', style: CustomStyles.dark12TextStyle()),
                Container(
                    margin: EdgeInsets.only(top: 5),
                    child: Text(
                        StringUtils.checkedString(_secondAuditionInfo[
          ...
          Container(
              child: Column(children: [
            Text('합격', style: CustomStyles.dark12TextStyle()),
            Container(
                margin: EdgeInsets.only(top: 5),
                child: Text(
                    StringUtils.checkedString(_secondAuditionInfo[
    ...
    return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Container(
              margin: EdgeInsets.only(right: 15),
              child: Column(children: [
                Text('2차 합격자', style: CustomStyles.dark12TextStyle()),
                Container(
                    margin: EdgeInsets.only(top: 5),
                    child: Text(
          ...
          Container(
              margin: EdgeInsets.only(right: 15),
              child: Column(children: [
                Text('면접완료', style: CustomStyles.dark12TextStyle()),
                Container(
                    margin: EdgeInsets.only(top: 5),
                    child: Text(
                        StringUtils.checkedString(_thirdAuditionInfo[
          ...
          Container(
              margin: EdgeInsets.only(right: 15),
              child: Column(children: [
                Text('면접대기', style: CustomStyles.dark12TextStyle()),
                Container(
                    margin: EdgeInsets.only(top: 5),
                    child: Text(
                        StringUtils.checkedString(_thirdAuditionInfo[
            ...
            ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  if (_data[APIConstants.result_type] != "계약요청전") {
                    _txtFieldPay.text =
                        _data[APIConstants.final_pay].toString();
                  }
                                ...
                                children: [
                                  ...
                                  Container(
                                      ...
                                      child: Text(
                                        ...
                                        style: CustomStyles.light12TextStyle(),
                                      ))
                                ]),
                            Container(
                            ...
                            Visibility(
                                child: Container(
                                    ...
                                    child: Container(
                                        ...
                                        height: 48,
                                        child: CustomStyles
                                            .greyBGRound7ButtonStyle('출연료 지급하기',
                                                () {
                                          requestPayToActor(
                                              context,
                                              _data[APIConstants
                                ...
                                visible: (StringUtils.checkedString(_data[
                                                APIConstants.result_type]) ==
                                            "계약완료" &&
                        ...
                        Container(
                            child: Column(
                              ...
                              Expanded(
                                  ...
                                  child: RefreshIndicator(
                                    ...
                                    child: SingleChildScrollView(
                                        ...
                                        key: (_tabIndex == 0)
                                            ? ObjectKey(
                                                _firstAuditionApplyList.length >
                                                        0
                                                    ? _firstAuditionApplyList[0]
                                                    : "")
                                            : ((_tabIndex == 1)
                                                ? ObjectKey(_secondAuditionApplyList
                                                            .length >
                                                        0
                                                    ? _secondAuditionApplyList[
                                                        0]
                                                        ...
                                                        Expanded(
                                                            ...
                                                            child: Column(
                                                                ...
                                                                children: [
                                                                  Container(
                                                                      child: Text(
                                                                          StringUtils.checkedString(_firstAuditionInfo[APIConstants
                                                                              .project_name]),
                                                                          style:
                                                                              CustomStyles.darkBold10TextStyle())),
                                                                  Container(
                                                                      margin: EdgeInsets.only(
                                                                          top:
                                                                              5),
                              ...
                              Visibility(
                                ...
                                visible: (_tabIndex == 1 &&
                                        _firstAuditionInfo[APIConstants
                                                .isOpenSecondAudition] ==
                                            0)
                                    ? true
                                    : false,
  ...
  * */
  Future<void> requestOpenSecondAudition(BuildContext context) async {
    ...
    if(KCastingAppData().isWeb){
      params[APIConstants.target_files] = _pickedMultipartFile;
    }else{
