                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Container(
                                                        ...
                                                        padding:
                                                            EdgeInsets.all(2.0),
                                                        child: ClipOval(
                                                            child: (_scoutData[APIConstants.production_img_url] !=
                                                                    null)
                                                                ? CachedNetworkImage(
                                                                    fit: BoxFit
                                                                        .cover,
                                                                    ...
                                                                    imageUrl:
                                                                        _scoutData[APIConstants.production_img_url],
                                  ...
                                  children: [
                                    Container(
                                        ...
                                        (KCastingAppData().isWeb)
                                            ? CustomStyles.appWidth * 0.5
                                            : MediaQuery.of(context).size.width *
                                                0.5,
                                        height: 55,
                                        child: CustomStyles
                                            .greyBGSquareButtonStyle('거절하기',
                                                () {
                                          showDialog(
                                              context: context,
