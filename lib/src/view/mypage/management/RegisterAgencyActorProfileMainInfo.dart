...
class RegisterAgencyActorProfileMainInfo extends StatefulWidget {
  ...
  const RegisterAgencyActorProfileMainInfo(
      {Key key, this.name, this.gender, this.phone})
      : super(key: key);
...
class _RegisterAgencyActorProfileMainInfo
  ...
  * */
  void requestUpdateApi(BuildContext context) {
    ...
    infoTargetData[APIConstants.actor_name] =
    ...
    infoTargetData[APIConstants.management_seq] =
    ...
    replaceView(
        context,
        RegisterAgencyActorProfileSubInfo(
